...
api.delete('/borrarCategoria/:id', md_auth.ensureAuth, CategoryController.deleteCategory);
api.put('/editarCategoria/:id', md_auth.ensureAuth, CategoryController.editCategory);
